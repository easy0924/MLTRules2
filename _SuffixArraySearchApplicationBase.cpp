/**
* Revision $Rev: 2355 $
* Last Modified $LastChangedDate: 2007-01-15 20:45:09 -0500 (Mon, 15 Jan 2007) $
**/
...
void C_SuffixArraySearchApplicationBase::loadData_forSearch(const char * filename, bool noVoc, bool noOffset)
{
	...
	this->loadData(filename, noVoc, noOffset, false);	//call the constructor of the super class
