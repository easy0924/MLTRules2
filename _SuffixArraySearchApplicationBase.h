...
*
* Revision $Rev: 2353 $
* Last Modified $LastChangedDate: 2007-01-15 20:24:17 -0500 (Mon, 15 Jan 2007) $
**/
...
public:
	...
	void calcNgramMatchingInfoTokenFreqOnlyExtendingCurrentMatch(TextLenType currentMatchStart, unsigned char currentMatchLen, IndexType nextWord, int maxLenOfNgramConsidered, double * freqTable, TextLenType & updatedMatchingStart,  unsigned char & updatedMatchingLen);
